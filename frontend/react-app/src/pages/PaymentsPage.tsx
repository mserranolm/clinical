  ...
  return (
    <section className="page-section">
      ...
      <PageHeader
        ...
        title="Pagos"
        subtitle="Registro de cobros y pagos"
      />

      {/* Summary Cards */}
      <div className="stats-grid" style={{ marginBottom: 24 }}>
        <article
          className="stat-card elite-card"
        ...
        >
          ...
          <h3 style={{ color: "#10b981", fontSize: "1.6rem" }}>
            {fmtCurrency(totalUSD, "USD")}
          </h3>
          <span style={{ color: t.textSub, fontSize: "0.75rem" }}>
            {filtered.filter((p) => p.currency === "USD").length} transacciones
          </span>
        </article>
        <article
          className="stat-card elite-card"
          ...
          >
            ...
            >
              <DollarSign
                size={16}
                strokeWidth={1.5}
                color={t.iconPurpleText}
              />
            </div>
            <small style={{ margin: 0 }}>Total VES</small>
          </div>
          <h3 style={{ color: "#8b5cf6", fontSize: "1.6rem" }}>
            {fmtCurrency(totalVES, "VES")}
          </h3>
          <span style={{ color: t.textSub, fontSize: "0.75rem" }}>
            {filtered.filter((p) => p.currency === "VES").length} transacciones
          </span>
        </article>
                    ...
                    <td style={{ padding: "10px 12px" }}>
                      <span
                        style={{
                          ...
                          fontWeight: 600,
                          background:
                            p.paymentType === "pago_completo"
                              ? t.pillPagoCompleto.bg
                              : t.pillAbono.bg,
                          color:
                            p.paymentType === "pago_completo"
                              ? t.pillPagoCompleto.color
                              : t.pillAbono.color,
                        }}
                      >
